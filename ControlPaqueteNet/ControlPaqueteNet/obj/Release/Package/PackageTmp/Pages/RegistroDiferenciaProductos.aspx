<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegistroDiferenciaProductos.aspx.cs" Inherits="ControlPaqueteNet.Pages.RegistroDiferenciaProductos" %>
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td valign="top" align="center">
                        ...
                        <asp:GridView ID="grProductos" runat="server" AutoGenerateColumns="False" AllowSorting="True" Width="750px" OnDataBound="grProductos_DataBound" OnSelectedIndexChanged="grProductos_SelectedIndexChanged">
                            <Columns>
