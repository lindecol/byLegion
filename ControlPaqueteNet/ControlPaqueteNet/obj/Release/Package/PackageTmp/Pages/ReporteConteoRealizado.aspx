<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReporteConteoRealizado.aspx.cs" Inherits="ControlPaqueteNet.Pages.ReporteConteoRealizado" %>
...
<asp:content id="Content4" contentplaceholderid="ContentPlaceHolder4" runat="server">
        ...
        <tr>
            <td>
                <asp:Label ID="lblTitulo" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Teal"
                    Text="Reporte Conteo Realizado"></asp:Label>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 190px">
                ...
                <asp:Image ID="ibFechaInicio" runat="server" ImageUrl="~/Images/Calendar.gif" Width="16px" />
                <cc1:CalendarExtender ID ="CalendarioFechaIN"  PopupButtonID="ibFechaInicio" runat ="server" Format="dd/MM/yyyy"  TargetControlID="txtFechaInicio" FirstDayOfWeek="Friday"></cc1:CalendarExtender>
            </td>
        </tr>
        <tr>
            <td style="width: 126px">
            ...
            <td style="width: 190px">
                ...
                <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/Calendar.gif" Width="16px" />
                <cc1:CalendarExtender ID ="CalendarioFechaFi" PopupButtonID="Image2" runat ="server" Format="dd/MM/yyyy" TargetControlID="txtFechaFin" ></cc1:CalendarExtender>
            </td>
        </tr>
    </table>
                    </ContentTemplate>
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/descargar.jpg" />
    ...
    &nbsp;<%--Error--%>
     <rsweb:ReportViewer ID="rvReporte" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ...
                    <LocalReport ReportPath="reportes\Report_ConteoRealizado.rdlc">
                        <DataSources>
