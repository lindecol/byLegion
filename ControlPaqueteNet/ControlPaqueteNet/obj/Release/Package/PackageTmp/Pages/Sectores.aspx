<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.Master" AutoEventWireup="true" CodeBehind="Sectores.aspx.cs" Inherits="ControlPaqueteNet.Pages.Sectores" %>
               ...
               <center>
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        ...
                        <asp:Label ID="Label3" runat="server" Font-Size="Small" Text="Código:" ForeColor="Teal" Font-Bold="True"></asp:Label>&nbsp;
