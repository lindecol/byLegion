<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.Master" AutoEventWireup="true" CodeBehind="Apertura.aspx.cs" Inherits="ControlPaqueteNet.Pages.Apertura" %>
        ...
        <tr>
            <td valign="top" align="left">
                ...
                <%--Colocamos el UpdatePanel para nuestros asuntos en AJAX--%>
                        <asp:GridView ID="grApertura" runat="server" AutoGenerateColumns="False" AllowSorting="True" Width="750px" OnDataBound="grApertura_DataBound" OnRowEditing="grApertura_RowEditing1" >
                            <Columns>
