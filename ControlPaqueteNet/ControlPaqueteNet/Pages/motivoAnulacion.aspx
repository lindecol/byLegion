<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPage.Master" AutoEventWireup="true" CodeBehind="motivoAnulacion.aspx.cs" Inherits="ControlPaqueteNet.Pages.motivoAnulacion" %>
        ...
        <tr>
            <td valign="top" align="center">
                ...
                <asp:Label ID="lblTitulo" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="Teal"
                    Text="Motivos de Anulación"></asp:Label>
                <br />
                <hr style="width:100%" />
            </td>
        </tr>
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="grAnulacion" runat="server" AutoGenerateColumns="False" AllowSorting="True" Width="750px">
                            <Columns>
                                <asp:BoundField DataField="codigo_anulacion" HeaderText="C&#243;digo" >
                                    <ControlStyle Width="70px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="descripcion_anulacion" HeaderText="Descripci&#243;n" >
                                    <ControlStyle Width="440px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="estado_anulacion" HeaderText="Estado">
