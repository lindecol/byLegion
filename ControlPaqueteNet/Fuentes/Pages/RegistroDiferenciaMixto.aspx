<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegistroDiferenciaMixto.aspx.vb" Inherits="ControlPaquete.RegistroDiferenciaMixto" MasterPageFile="~/Pages/MasterPage.Master" %>
        ...
        <ContentTemplate>
            <table style="width:100%">
                ...
                <tr>
                    <td valign="top" align="center">
                        ...
                        <asp:GridView ID="grProductos" runat="server" AutoGenerateColumns="False" Width="100%" OnDataBound="grProductos_DataBound" >
                            <Columns>
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td valign="top" align="center">
                        <%--Grilla donde mostraremos los datos--%>
                        <asp:GridView ID="grActivoPropio" runat="server" AutoGenerateColumns="False" Width="750px" OnDataBound="grActivoPropio_DataBound">
                            <Columns>
                ...
                <tr>
                    <td valign="top" align="center">
                        <%--Grilla donde mostraremos los datos--%>
                        <asp:GridView ID="grActivoAjeno" runat="server" AutoGenerateColumns="False" Width="750px" OnDataBound="grActivoAjeno_DataBound">
                            <Columns>
                                <asp:BoundField DataField="ID_ACTIVO_PRODUCTO" HeaderText="C&#243;digo" >
                                    <ControlStyle Width="80px" />
                                </asp:BoundField>
