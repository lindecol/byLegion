...
{
	public class ReporteDiferencia : System.Web.UI.Page
	{
		...
		protected virtual ImageButton btnScript
		{
			...
			set
			{
				...
				{
					ReporteDiferencia reporteDiferencium = this;
					this._btnScript.Click -= new ImageClickEventHandler(reporteDiferencium.btnScript_Click);
				}
				this._btnScript = value;
				if (this._btnScript != null)
				{
					ReporteDiferencia reporteDiferencium1 = this;
					this._btnScript.Click += new ImageClickEventHandler(reporteDiferencium1.btnScript_Click);
				}
			}
		}
		...
		protected virtual DropDownList cmbTipoProgramacion
		{
			...
			set
			{
				...
				{
					ReporteDiferencia reporteDiferencium = this;
					this._cmbTipoProgramacion.SelectedIndexChanged -= new EventHandler(reporteDiferencium.cmbTipoProgramacion_SelectedIndexChanged);
				}
				this._cmbTipoProgramacion = value;
				if (this._cmbTipoProgramacion != null)
				{
					ReporteDiferencia reporteDiferencium1 = this;
					this._cmbTipoProgramacion.SelectedIndexChanged += new EventHandler(reporteDiferencium1.cmbTipoProgramacion_SelectedIndexChanged);
				}
			}
		}
		...
		[DebuggerNonUserCode]
		static ReporteDiferencia()
		{
			ReporteDiferencia.__ENCList = new ArrayList();
		}

		public ReporteDiferencia()
		{
			ReporteDiferencia reporteDiferencium = this;
			base.Load += new EventHandler(reporteDiferencium.Page_Load);
			ArrayList _ENCList = ReporteDiferencia.__ENCList;
			Monitor.Enter(_ENCList);
			try
			{
				ReporteDiferencia.__ENCList.Add(new WeakReference(this));
			}
			finally
			{
