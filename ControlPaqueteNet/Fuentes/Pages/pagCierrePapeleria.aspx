<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagCierrePapeleria.aspx.vb" Inherits="ControlPaquete.pagCierrePapeleria" MasterPageFile="~/Pages/MasterPage.Master" %>
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server" />
    ...
    <table style="width: 347px">
        ...
        <tr>
            ...
            <table width="60%">
                <tr>
                    <td align="left"><asp:ImageButton ID="ibAtras" runat="server" ImageUrl="~/Images/Atras.GIF" ToolTip="Atrás" Width="24px" /></td>
