<%@ Page Title="Remito" Language="C#" MasterPageFile="~/PaginaMaestra/MasterPage.Master" AutoEventWireup="true" CodeBehind="Remito.aspx.cs" Inherits="TransferenciaZonaFranca.PaginasReportes.Remito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div  style="width:940px;float:left;margin-left:7%">
        ...
        <asp:Label ID="lblSucursal" runat="server" Visible="false" Text="Label"></asp:Label>
         ...
         <%--   TypeName="TransferenciasZF.DsRemisionTableAdapters.DataTable1TableAdapter">--%>
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="lblDocumento" Name="DOCUMENTO" 
                    ...
                    <asp:ControlParameter ControlID="lblSucursal" Name="SUCURSAL" 
                    PropertyName="Text" Type="String" />
            </SelectParameters>
