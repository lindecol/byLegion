<%@ Page Title="Remito" Language="C#" MasterPageFile="~/PaginaMaestra/MasterPage.Master" AutoEventWireup="true" CodeBehind="SesionMultiple.aspx.cs" Inherits="TransferenciasZF.SesionMultiple" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="Titulos" style="float:left;width:700px" >  Error de ingreso: Usuario ya 
        tiene&nbsp; una sesion abierta en el Modulo</div>
    <br />
      <br />
        <br />
