<%@ Page Title="Remito" Language="C#" MasterPageFile="~/PaginaMaestra/MasterPage.Master" AutoEventWireup="true" CodeBehind="LotesSeriales.aspx.cs" Inherits="TransferenciaZonaFranca.PaginasReportes.LotesSeriales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="Titulos" style="float:left;width:490px" >  SEGUIMIENTO SALIDAS LOTES DE PRODUCCIÓN </div>
    <br />
      <br />
        <br />
        ...
        <div  style="float:left;width:300px">
                    <span><label for="lblDocumento">Número Lote:</label></span>        
                    <span  class="form-el">
