...
$('#btnAgregarSerial').click(function () {
    ...
    var data = JSON.stringify({ IdSerial: jQuery.trim($('#txtSerial').val()), sLote: jQuery.trim($('#txtLote').val()), Usuario: jQuery.trim($('#lblNombreUsuario').text()),ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
...
function CargarTablaLotes(registros) {
    ...
    var encabezados = [
            ...
            , { h: 'Estado', style: 'width: 100px', sort: 'Lote' }
