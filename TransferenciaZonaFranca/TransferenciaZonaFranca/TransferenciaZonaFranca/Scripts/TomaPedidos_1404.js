...
$('#txtVolumen').focusout(function () {
    ...
    //No aplica para toma de Pedidos
   // if (VolumenActual != "") {
...
function CargarSucursales(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/SucursalesPorEmpresa',
        data: datos,
...
function ConsultarProducto(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ConsultarProducto',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
...
function ConsultarCargueAutomaticoZF(idEmpresa,Cargue) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ConsultarCargueAutomaticoZF_GuiaCarga',
        data: datos,
        error: function (objeto, quepaso, otroobj) {
            mostrarError(objeto, quepaso, otroobj);
        },
...
function ConsultarTubo(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ConsultarTubo',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
...
function BuscarFactorVta(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/BuscarFactorVta',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == 0) {
...
function CantidadProductosEnRampa(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/CantidadProductosEnRampa',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
function ValidarCapacidad(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ValidarCapacidad',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function EsGasStockeable(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/GasStockeable',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function EsRutaRampa(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/EsRutaRampa',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function EsVehiculoValido(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/EsVehiculoValidoGuiaCamion',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function EstaEnTransitoCamion(idEmpresa) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, PlacaVehiculo: $("#txtVehiculo").val(), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'TomaPedidos.aspx/EstaEnTransitoCamion',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function ValidarSiHayInventarioAbierto(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ValidarSiHayInventarioAbierto',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
                ...
                //No Aplica para Toma de Pedidos  ValidarCargueOBC(idEmpresa);

                ProcesarTomaPedidos(idEmpresa);
...
function ValidarCargueOBC(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ValidarCargueOBC',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
function ValidarSiTieneListaPrecios(idEmpresa, cliente, producto, espropio) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ValidarSiTieneListaPrecios',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function ValidarSiTieneCod_Facturacion(idEmpresa, producto, espropio) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ValidarSiTieneCod_Facturacion',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function RutaTieneAlmacen(idEmpresa) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, CodigoRuta: $("#txtRuta").val(), Agencia: jQuery.trim($('#lblAgencia1').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'TomaPedidos.aspx/RutaTieneAlmacen',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length == 0) {
...
function ValidarPapeleriaRuta(idEmpresa) {
    ...
    var datos = JSON.stringify({ IdEmpresa: jQuery.trim($('#cmbEmpresaDestino').val()), CodigoRuta: $("#txtRutaSalida").val(), Agencia: jQuery.trim($('#CmbSucursalDestino').val()), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'TomaPedidos.aspx/ValidarPapeleriaRuta',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length > 0) {
...
function FacturaGenerada(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/FacturaGenerada',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato != "") {
...
function GuiaCamionGenerada(idEmpresa) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, comprobante: $("#txtNumeroDocumento").val(), Agencia: jQuery.trim($('#lblAgencia1').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'TomaPedidos.aspx/GuiaCamionGenerada',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato != "") {
...
function DatosConductor(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/DatosConductor',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length == 0) {
...
function ConsultarArticuloPorNombre(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TomaPedidos.aspx/ConsultarArticuloPorNombre",
...
function ConsultarConductorPorNombre(Nombre) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TomaPedidos.aspx/ConsultarConductorPorNombre",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (data, textStatus) {
...
function ConsultarArticuloPorCodigo(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TomaPedidos.aspx/ConsultarArticuloPorCodigo",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (data, textStatus) {
...
function AmacenarDetalleTablaTemporal_Totalizado(codigo, capacidad, cantidad, volumen, secuencia, opcion) {
    ...
    var data = JSON.stringify({ registro: registro });
    $.ajax({
        url: 'TomaPedidos.aspx/GrabarDetalleTemporal',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.IdError == '02') {
...
function AmacenarDetalleTablaTemporalAgenos(Opcion) {
    ...
    var data = JSON.stringify({ registro: registro, ModoCargue: 'M', Usuario: jQuery.trim($('#lblNombreUsuario').text()), IdEmpresa: $('#hdIdEmpresa').val(), ConectarA: jQuery.trim($('#lblBd').text()), Doc:'P' });
    $.ajax({
        url: 'TomaPedidos.aspx/GrabarDetalleTemporalAgenos',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.IdError == '02') {
...
function ProcesarTomaPedidos(idEmpresa) {

    var textofecha = jQuery.trim($('#txtFecha').val());
    var textofechaEntrega = jQuery.trim($('#txtFechaEntrega').val());
    
    textofecha = textofecha.length;
    textofechaEntrega = textofechaEntrega.length;

    if (textofecha != 10) {
        jAlert('Fecha Incorrecta', 'Validación datos');
        $("#Principal").unmask();
        return;

    }

    if (textofechaEntrega != 10) {
        jAlert('Fecha Entrega Incorrecta', 'Validación datos');
        $("#Principal").unmask();
        return;
...
//    }
    ...
    if ((ItemsProductos.Productos.length == 0) && (ItemsProductosParticulares.ProductosParticulares == 0)) {
        ...
        jAlert('No ha Ingresado Productos para el Pedido', 'Validación Datos');
        $("#Principal").unmask();
        return;
    }
    ...
    registro.IdGrupo = 1;
    registro.SubdepositoDestino = 0;//  jQuery.trim($('#hdSubdepositoDestino').val());
    registro.SubdepositoOrigen = 0;// jQuery.trim($('#hdSubdepositoSucursal').val()); //; // por Logueo
    registro.CodigoRuta = '0';// jQuery.trim($('#txtRuta').val());
    ...
    registro.Conductor = '0';//  jQuery.trim($('#txtCodigoConductor').val());
    registro.Vehiculo = '0';//jQuery.trim($('#txtVehiculo').val());
    registro.Prefijo = '0';//  jQuery.trim($('#txtTalonario').val());
    // registro.FechaComprobante = GenerarFechaJsonFecha(jQuery.trim($('#txtFecha').val()));
    registro.FechaComprobante = jQuery.trim($('#txtFechaEntrega').val());
    registro.ObservacionSerial = '';// ArmarCadenaProductoSeriales();
    registro.GuiaSalida = 0//jQuery.trim($('#txtRutaSalida').val()); 
    registro.FechaComprobante = jQuery.trim($('#txtFechaEntrega').val());
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/ProcesarTomaPedido',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.IdError == "01") {
...
function EliminarProductoGrillaPropia(Producto, Volumen, EsPropio, Secuencia, Tubo,Capacidad) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/EliminarProductoGrillaPropia',
        data: data,
        success: function (response) {
...
function VerificarEsatadoLLenoVacio(idEmpresa) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/VerificarEstadoLLenoVacio',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            // 0 Cilindro vacio
...
function ValidarCantidadStock(idEmpresa, EsPropio) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, Subdeposito: subDeposito, Producto: Producto, Usuario: jQuery.trim($('#lblNombreUsuario').text()), ConectarA: jQuery.trim($('#lblBd').text()),Doc:'I' });
    $.ajax({
        url: 'TomaPedidos.aspx/ValidarCantidadStock',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
$(function () {
    ...
    $("#txtRuta").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'TomaPedidos.aspx/RutasPorSucursal',
...
function EliminarTablaTemporalInicial(idEmpresa) {
    ...
    var data = JSON.stringify({ TempIdEmpresa: jQuery.trim($('#hdIdEmpresa').val()), Usuario: jQuery.trim($('#lblNombreUsuario').text()), ConectarA: jQuery.trim($('#lblBd').text()),Doc:'P' });
    $.ajax({
        url: 'TomaPedidos.aspx/EliminaDetalleTemporalInicial',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            //            if (Tdato.IdError == '02') {
...
function RutaTieneCamion(idEmpresa,Ruta,Agencia) {
    ...
    $.ajax({
        url: 'TomaPedidos.aspx/EsRemitoCamion',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
$('#btnDarBajaPedido').click(function () {


        if (jQuery.trim($('#txtNroPedido').val()) == '') {
                jAlert('Digite Número de pedido', 'Validación Datos');
                return;
        }
    ...
    $('#txtNroPedido').focusout(function () {

        if ($('#txtNroPedido').val() != "") {


            var datos = JSON.stringify({ Pedidos: jQuery.trim($('#txtNroPedido').val()), Sucursal: jQuery.trim($('#lblAgencia1').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
            $.ajax({
                url: 'BajaPedidos.aspx/ExistePedido',
                data: datos,
                success: function (response) {
                    var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
                    if (Tdato == false) {
                        jAlert('Pedido no existe o no corresponde a la sucursal de origen', 'Validación');
                        $("#txtNroPedido").val('');
...
function ProcesarBajaPedidos() {
 


    var data = JSON.stringify({ IdPedido: jQuery.trim($('#txtNroPedido').val()), Estado: jQuery.trim($('#cmbNuevoEstado').val()), Observaciones: jQuery.trim($('#txtObservacionPedido').val()), Usuario: jQuery.trim($('#lblNombreUsuario').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'BajaPedidos.aspx/ProcesarBajaPedido',
        data: data,
        success: function (response) {
            jAlert('Proceso Terminado Satisfactoriamente');
        }
