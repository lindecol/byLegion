...
$('#btnGuardarAsig').click(function () {
    ...
    if (parseInt(Asignación) > parseInt(prestamo)) {
        ...
        $.ajax({
            url: 'DocumentoTransferenciaSinFact.aspx/GrabarAsignacion',
            data: data,
...
$('#btnAgregarSerial').click(function () {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/GrabarSerialLoteTemp',
        data: data,
        success: function (response) {
            ConsultarSerialLote();
...
$('#btnProcesar').click(function () {
    ...
    if ($('#hdIdEmpresa').val() == '25') {// por ahora solo aplica a PGI
        ...
        if (jQuery.trim($('#txtFactura_').val()) == '') {
            jAlert('Se requiere digitar una factura que haya sido generada previamente', 'Validación Datos');
            $("#Principal").unmask();
            return;
        }
...
function CargarSucursales(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/SucursalesPorEmpresa',
        data: datos,
...
function ConsultarProducto(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ConsultarProducto',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
...
function ConsultarCargueAutomaticoZF(idEmpresa,Cargue) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ConsultarCargueAutomaticoZF',
        data: datos,
        error: function (objeto, quepaso, otroobj) {
            mostrarError(objeto, quepaso, otroobj);
        },
...
function ConsultarCargueAutomaticoZFSerialLote(idEmpresa, Cargue) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferenciaSinFact.aspx/ConsultarCargueAutomaticoZFSerialLote",
...
function ConsultarSerialLote() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferenciaSinFact.aspx/ConsultarSerialLote",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (response, textStatus) {
...
function ConsultarCilindrosPatrimonio() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferenciaSinFact.aspx/Cilindros_a_transferir",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (response, textStatus) {
...
function ConsultarTubo(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ConsultarTubo',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
...
function BuscarFactorVta(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/BuscarFactorVta',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == 0) {
...
function CantidadProductosEnRampa(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/CantidadProductosEnRampa',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
function ValidarCapacidad(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarCapacidad',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function EsGasStockeable(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/GasStockeable',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function EsLoteable(idEmpresa, Opcion) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, CodigoProducto: strCodigoProducto, ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/EsProductoLoteable',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function EsRutaRampa(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/EsRutaRampa',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function EsVehiculoValido(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/EsVehiculoValido',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function ValidarSiHayInventarioAbierto(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarSiHayInventarioAbierto',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function ValidarCargueOBC(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarCargueOBC',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.MensajeError != "0") {
                ...
                ValidarTotalConFactPrevia(idEmpresa);
...
//Función que valida que el total de productos a salir, sea igual al total de la factura previa asignada al remito
function ValidarTotalConFactPrevia(idEmpresa) {

    var datos = JSON.stringify({ Usuario: jQuery.trim($('#lblNombreUsuario').text()), Factura: jQuery.trim($('#txtFactura_').val()), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarTotalConFactPrevia',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true ) {
                jAlert('El total de los productos a facturar no es igual al total de la factura asignada', 'Validación de datos');
                $("#Principal").unmask();
            } else {
...
function ValidarSiTieneListaPrecios(idEmpresa, cliente, producto, espropio) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarSiTieneListaPrecios',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function ValidarSiTieneCod_Facturacion(idEmpresa, producto, espropio) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarSiTieneCod_Facturacion',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function RutaTieneAlmacen(idEmpresa) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, CodigoRuta: $("#txtRuta").val(), Agencia: jQuery.trim($('#lblAgencia1').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/RutaTieneAlmacen',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length == 0) {
...
function FacturaGenerada(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/FacturaGenerada',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato != "") {
...
function DatosConductor(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/DatosConductor',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length == 0) {
...
function ConsultarArticuloPorNombre(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferenciaSinFact.aspx/ConsultarArticuloPorNombre",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
...
function ConsultarConductorPorNombre(Nombre) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferenciaSinFact.aspx/ConsultarConductorPorNombre",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (data, textStatus) {
...
function ConsultarArticuloPorCodigo(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferenciaSinFact.aspx/ConsultarArticuloPorCodigo",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (data, textStatus) {
...
function AmacenarDetalleTablaTemporal(opcion) {
    ...
    //    $.ajax({
    //        url: 'DocumentoTransferenciaSinFact.aspx/GrabarDetalleTemporal',
    //        data: data,
    //        success: function (response) {
    //            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
    //            if (Tdato.IdError == '02') {
...
function AmacenarDetalleTablaTemporalAgenos(Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/GrabarDetalleTemporalAgenos',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.IdError == '02') {
...
if ((ItemsProductos.Productos.length == 0) && (ItemsProductosParticulares.ProductosParticulares == 0) && (ItemsProductosSinLote.ProductosSinLote == 0)) {
    ...
    registro.FacturaPrevia = jQuery.trim($('#txtFactura_').val()); 
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ProcesarTransaferencia',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.IdError == "01") {
...
function EliminarProductoGrillaPropia(Producto, Volumen, EsPropio, Secuencia, Tubo,Capacidad) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/EliminarProductoGrillaPropia',
        data: data,
        success: function (response) {
...
function VerificarEsatadoLLenoVacio(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/VerificarEstadoLLenoVacio',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            // 0 Cilindro vacio
...
function ValidarCantidadStock(idEmpresa, EsPropio,Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarCantidadStock',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
$(function () {
    ...
    $("#txtRuta").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'DocumentoTransferenciaSinFact.aspx/RutasPorSucursal',
...
function EliminarTablaTemporalInicial(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/EliminaDetalleTemporalInicial',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            //            if (Tdato.IdError == '02') {
...
function ValidarPedidos(Pedidos, Sucursal) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ValidarPedidos',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function TotalCilindrosSerieLote() {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/TotalCilindrosSerieLote',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
function EliminarTablaTemporalLoteSerie(Serial) {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/BorrarRegistroLoteSerie',
        data: data,
        success: function (response) {
            ConsultarSerialLote();
            TotalCilindrosSerieLote();
...
function ConsultaLotePorSerie() {
    ...
    $.ajax({
        url: 'DocumentoTransferenciaSinFact.aspx/ConsultarLotePorSerial',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
...
$("#txtFactura_").focusout(function () {

    if (jQuery.trim($('#txtFactura_').val()) != "") {


        var datos = JSON.stringify({ Factura: jQuery.trim($('#txtFactura_').val()), ConectarA: jQuery.trim($('#lblBd').text()) });
        $.ajax({
            url: 'DocumentoTransferenciaSinFact.aspx/ValidarFacturaPreviaExiste',
            data: datos,
            success: function (response) {
                var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
                if (Tdato.length != 0 && Tdato[0].FechaComprobante != 'N') {


                    $('#lblFacturaPrevia_').text(Tdato[0].FechaComprobante);
                    $('#lblValorFact').text(Tdato[0].ValorFacturaPrevia);


                } else {
                    jAlert('Factura Invalida o no existe', 'Validacion');

                    $('#lblFacturaPrevia_').text("");
                    $('#txtFactura_').val('');
                    return;
                }
