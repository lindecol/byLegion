...
$(document).ready(function () {
    ...
    //$('#txtPedidos').numeric(",");
        ...
        if ($("#lblIdEmpresa").text() =='21')
            ValidarSalidaCilindrosLLenos(jQuery.trim($('#lblSubdeposito').text()));
    ...
    //Tabular con la tecla Enter
    $("#txtCodigo_").keypress(function (e) {
        if (e.which == 13) {
            e.preventDefault();
            $('#txtDescripcion_').focus();
        }
    ...
    $("#txtDescripcion_").keypress(function (e) {
        if (e.which == 13) {
            e.preventDefault();
            $('#txtCantidad_').focus();
        }
    ...
    $("#txtCantidad_").keypress(function (e) {
        if (e.which == 13) {
            e.preventDefault();
            $('#txtCapacidad_').focus();
        }
    ...
    $("#txtCapacidad_").keypress(function (e) {
        if (e.which == 13) {
            e.preventDefault();
            $('#txtVolumen_').focus();
        }
    ...
    $("#txtVolumen_").keypress(function (e) {
        if (e.which == 13) {
            e.preventDefault();
            $('#txtObservacion_').focus();
        }
    });
    ...
    $("#txtObservacion_").keypress(function (e) {
        if (e.which == 13) {
            e.preventDefault();
            $('#btnAgregarProducto_').focus();
        }
    });
...
$('#btnCargarAut').click(function () {
    ...
    if (jQuery.trim($('#txtRuta').val()) == '') {
        jAlert('Se requiere digitar Ruta', 'Validación Datos');
        return;
    }
    ConsultarCargueAutomaticoZF($("#lblIdEmpresa").text(), jQuery.trim($('#txtRuta').val()));

    //Implementar hasta nueva orden
...
$('#btnAgregarProducto').click(function () {
    ...
    if (existe == false) {
        ...
        //no se pueden enviar cilindros PP llenos desde Oxicol  a tocancipa
        if ($('#hdIdEmpresa').val() == '21') {

            if (jQuery.trim($('#txtVolumen').val()) != "0") {

                if ($("#lblllenosPGI").text() == "F") {

                    //aqui
                    var data = JSON.stringify({ Codigo: jQuery.trim($('#txtCodigo').val()), Conectar_a: jQuery.trim($('#lblBd').text()) });
                    $.ajax({
                        url: 'DocumentoTransferencia.aspx/ValidarsiEsPPoSL',
                        data: data,
                        success: function (response) {
                            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
                            if (Tdato == '1') {

                                jAlert('No se permite la salida de producto de Propia Producción llenos ', 'Validación Datos');
                                return;

                            } else {

                             
                                ValidarCantidadStock(jQuery.trim($('#lblIdEmpresa').text()), 1, 1);
...
$('#btnAgregarProducto_').click(function () {


  

        var existe = ValidarExsiteProductoGrillaPropiosSinLote(jQuery.trim($('#txtCodigo_').val()), jQuery.trim($('#txtCapacidad_').val()), jQuery.trim($('#txtVolumen_').val()));

        existe = ValidarExsiteProductoGrillaPropios(jQuery.trim($('#txtCodigo_').val()), jQuery.trim($('#txtCapacidad_').val()), jQuery.trim($('#txtVolumen_').val()));
        if (existe == false) {

            if (jQuery.trim($('#txtCodigo_').val()) == '') {
                jAlert('Se requiere Digitar Código de Producto', 'Validación Datos');
                return;
            }

            if (jQuery.trim($('#txtCantidad_').val()) == '') {
                jAlert('Se requiere  digitar Cantidad', 'Validación Datos');
                return;
            }

            if (jQuery.trim($('#txtCapacidad_').val()) == '') {
                jAlert('Se requiere digitar Capacidad', 'Validación Datos');
                return;
            }

            if (jQuery.trim($('#txtVolumen_').val()) == '') {
                jAlert('Se requiere digitar volumen', 'Validación Datos');
                return;
            }

            ValidarCantidadStock(jQuery.trim($('#lblIdEmpresa').text()), 1, 3);
    ...
    if (existe == false) {
        ...
        if ($('#hdIdEmpresa').val() == '21') {
            ...
            if (jQuery.trim($('#txtVolumen1').val()) != '0') {
                ...
                if ($("#lblllenosPGI").text() == "F") {
                    var data = JSON.stringify({ Codigo: jQuery.trim($('#txtCodigo1').val()), Conectar_a: jQuery.trim($('#lblBd').text()) });
                    $.ajax({
                        url: 'DocumentoTransferencia.aspx/ValidarsiEsPPoSL',
                        data: data,
                        success: function (response) {
                            ...
                            if (Tdato == '1') {
                                ...
                                ValidarCantidadStock(jQuery.trim($('#lblIdEmpresa').text()), 2, 2);
                            }
...
$('#btnGuardarAsig').click(function () {
    ...
    var prestamo = jQuery.trim($('#txtcantidadAsig').text());
    var Asignación = jQuery.trim($('#txtAsigna').val());
    var Observ = jQuery.trim($('#txtObservacionesAsig').val());



    if (parseInt(Asignación) > parseInt(prestamo)) {
            jAlert('La Asignación  debe ser menor  o igual al prestamo', 'Validación Datos');
            return
        }

        if (jQuery.trim($('#txtAsigna').val()) == '') {
            jAlert('Se requiere digitar valor de asignación', 'Validación Datos');
            return
        }

        if (Observ.length > 100) {
            jAlert('El campo observación solo admite 100 caracteres', 'Validación Datos');
            return
        }


        var data = JSON.stringify({ producto: jQuery.trim($('#txtCodigoPAsig').text()), capacidad: jQuery.trim($('#txtCapacidadAsig').text()), Usuario: jQuery.trim($('#lblNombreUsuario').text()), ConectarA: jQuery.trim($('#lblBd').text()), Asign: jQuery.trim($('#txtAsigna').val()), Observacion: jQuery.trim($('#txtObservacionesAsig').val()) });
        $.ajax({
            url: 'DocumentoTransferencia.aspx/GrabarAsignacion',
            data: data,
            success: function (response) {
                $("#DivModificarPatri").dialog("destroy")
                ConsultarCilindrosPatrimonio();
            }
        })
...
$('#btnAgregarSerial').click(function () {
    ...
    if (jQuery.trim($('#txtLote').val()) == '0') {
        jAlert('El cilindro no tiene registra lote de llenado ', 'Validación Datos');
        return
    }
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/GrabarSerialLoteTemp',
        data: data,
        success: function (response) {
            ConsultarSerialLote();
    ...
    $('#btnAgregarSQR').click(function () {

        var existe = ValidarExsiteSQR(jQuery.trim($('#txtproductoSQR').val()), jQuery.trim($('#txtCapacidadSQR').val()), jQuery.trim($('#txtcodigoSQR').val()));

        if (existe == false) {

            if (jQuery.trim($('#txtproductoSQR').val()) == '') {
                jAlert('Se requiere Digitar Producto', 'Validación Datos');
                return
            }

            if (jQuery.trim($('#txtDescripcionSQR').val()) == '') {
                jAlert('Se requiere Descripcion Producto', 'Validación Datos');
                return
            }

            if (jQuery.trim($('#txtCapacidadSQR').val()) == '') {
                jAlert('Se requiere Capacidad ', 'Validación Datos');
                return
            }

            if (jQuery.trim($('#txtcodigoSQR').val()) == '') {
                jAlert('Se requiere Código SQR ', 'Validación Datos');
                return
            }


            var datos = JSON.stringify({ IdEmpresa: $('#hdIdEmpresa').val(), SQR: jQuery.trim($('#txtcodigoSQR').val()), ConectarA: jQuery.trim($('#lblBd').text()) });
            $.ajax({
                url: 'DocumentoTransferencia.aspx/VerificarExiteSQR',
                data: datos,
                success: function (response) {
                    var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
                    if (Tdato > 0) {
                       ...
                       GrabarSQR();
                        ...
                        jAlert('Número de SQR No existe o no esta abierto');
                         return;
                    }
            ...
            jAlert('Codigo de PRODUCTO-CAPACIDAD-SQR ya existe', 'Validación datos');
            return;
        }
    ...
    function GrabarSQR() {
            ...
            var data = JSON.stringify({ Producto: jQuery.trim($('#txtproductoSQR').val()), Capacidad: jQuery.trim($('#txtCapacidadSQR').val()), SQR: jQuery.trim($('#txtcodigoSQR').val()), Usuario: jQuery.trim($('#lblNombreUsuario').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
            $.ajax({
                url: 'DocumentoTransferencia.aspx/GrabarSQR',
                data: data,
                success: function (response) {

                    $('#txtproductoSQR').focus();
                    $('#txtDescripcionSQR').val('');
                    $('#txtproductoSQR').val('');
                    $('#txtCapacidadSQR').val('');
                    $('#txtcodigoSQR').val('');
...
$('#btnProcesar').click(function () {
    ...
    if ($('#hdIdEmpresa').val() == '25') {// por ahora solo aplica a PGI
        var cilindrosLotes = jQuery.trim($('#lblTotalCilindrosLote').text());
        var cilindrosLlenos = jQuery.trim($('#lblTotalcilindrosLLenos').text());

        jQuery.trim($('#lblIdEmpresa').text())
...
$('#btnVista').click(function () {
    ...
    $("#btnPatrimonio").removeAttr('disabled');
});
...
$('#txtCodigo_').focusout(function () {
    ...
    if ($('#txtCodigo_').val() != "") {
       ...
       EsLoteable(jQuery.trim($('#lblIdEmpresa').text()), 3);

//        if (EsLoteable_ == true) {
//            ConsultarProducto(jQuery.trim($('#lblIdEmpresa').text()), 3);

//            $('#txtCantidad_').val('');
//            $('#txtCapacidad_').val('');
//            $("#txtCapacidad_").numeric(".");
//            $("#txtCantidad_").numeric(".");
//            $("#txtVolumen_").numeric(".");
//        } else {
//            jAlert('El Código de producto debe contener lote de producción', 'Validación datos');
//            $('#txtCodigo_').val('')
//        }
    }
...
$('#txtproductoSQR').focusout(function () {


    if ($('#txtproductoSQR').val() != "") {
        ConsultarProducto(jQuery.trim($('#lblIdEmpresa').text()), 4);
        $("#txtCapacidadSQR").numeric(".");
    }
...
$('#txtVolumen_').focusout(function () {

    var Cantidad = $('#txtCantidad_').val();
    var Capacidad = $('#txtCapacidad_').val();
    var VolumenActual = $('#txtVolumen_').val();
    var VolumenCalculado = Cantidad * Capacidad;
    ...
    if (VolumenActual != "") {
        CantidadProductosEnRampa(jQuery.trim($('#lblIdEmpresa').text()), 3);
    }
});
...
$('#txtCapacidad_').focusout(function () {

    ValidarCapacidad(jQuery.trim($('#lblIdEmpresa').text()), 3);
});
...
function CargarSucursales(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/SucursalesPorEmpresa',
        data: datos,
...
function ConsultarProducto(idEmpresa, Opcion) {
    ...
    if (Opcion == 3)
        strCodigoProducto = $("#txtCodigo_").val();
    if (Opcion == 4)
        strCodigoProducto = $("#txtproductoSQR").val();

    var datos = JSON.stringify({ IdEmpresa: idEmpresa, Codigo: strCodigoProducto, ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ConsultarProducto',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
                ...
                if (Tdato[0].EsCuentaCorriente != 'N') {
                    ...
                    if (Opcion == 1) {
                        ...
                        if (Opcion == 3) {
                            $('#txtDescripcion_').val(Tdato[0].Descripcion);
                            $('#txtCodigo_').val(Tdato[0].Codigo);

                        } if (Opcion == 4) {
                            $('#txtDescripcionSQR').val(Tdato[0].Descripcion);
                            $('#txtproductoSQR').val(Tdato[0].Codigo);
                    ...
                    jAlert('El Producto ' + strCodigoProducto + ' No es de Cuenta Corriente', 'Maestro Productos');
                    LimpiarControles(Opcion);

                }

            } else {
                jAlert('El Producto ' + strCodigoProducto + ' No existe, o No está Habilitado', 'Maestro Productos');
...
function ConsultarCargueAutomaticoZF(idEmpresa,Cargue) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ConsultarCargueAutomaticoZF',
        data: datos,
        error: function (objeto, quepaso, otroobj) {
            mostrarError(objeto, quepaso, otroobj);
        },
        success: function (response) {
            ...
            if (Tdato != null) {
                ...
                //se valida que no exista en la grilla un ajeno repetido
                var existe;
                var ExisteSecuencia = '';
                for (var i = 0; i < Tdato.length; i++) {

                    existe = ValidarExsiteProductoGrillaAjenos(Tdato[i].Secuencia);
                    if (existe == true) {
                        ExisteSecuencia = ExisteSecuencia + '-' + Tdato[i].Secuencia;
                    }
                }

                if (ExisteSecuencia.length > 0) {

                    jAlert('Los números de secuencia:' + ExisteSecuencia + 'ya existen en la grilla');
                    return;
                ...
                for (var i = 0; i < Tdato.length; i++) {
                    ...
                    if (Tdato[i].Secuencia != "0") {
                        //  
                        AlmacenarDetalleTablaTemporalAgenos_Aut(2, Tdato[i].Codigo, Tdato[i].Capacidad, Tdato[i].Cantidad, Tdato[i].Volumen, Tdato[i].PropietarioTubo, Tdato[i].Tubo, Tdato[i].Lote,Tdato[i].Secuencia);
                        ...
                        AlmacenarDetalleTablaTemporalAgenos_Aut(1, Tdato[i].Codigo, Tdato[i].Capacidad, Tdato[i].Cantidad, Tdato[i].Volumen, Tdato[i].PropietarioTubo, Tdato[i].Tubo, '',0);
...
function ConsultarCargueAutomaticoZFSerialLote(idEmpresa, Cargue) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferencia.aspx/ConsultarCargueAutomaticoZFSerialLote",
...
function ConsultarSerialLote() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferencia.aspx/ConsultarSerialLote",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (response, textStatus) {
...
function ConsultarValidezSQR() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferencia.aspx/ConsultarSQR",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (response, textStatus) {
            ...
            AddSQR = new clsProductos();

            AddSQR = registros;

            ItemsSQR.ProductosSQR = AddSQR;

            CargarTablaSQR(registros);
        },
        error: function (request, status, error) {
            alert(jQuery.parseJSON(request.responseText).Message);
        }
...
function ConsultarCilindrosPatrimonio() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferencia.aspx/Cilindros_a_transferir",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (response, textStatus) {
            ...
            AddCilindroPatri = new clsProductos();

            AddCilindroPatri = registros;

            ItemsCilindrosPatri.CilindrosPatri = AddCilindroPatri;

            CargarCilindrosPatri(registros);
...
function CargarCilindrosPatri(registros) {
    ...
    var encabezados = [
             { h: 'Código', style: 'width: 50px;', sort: 'ProductoId' },
              { h: 'Producto', style: 'width: 250px;', sort: 'Descripcion' }
             , { h: 'Cap', style: 'width: 25px', sort: 'Cap' }
             , { h: 'Cant', style: 'width: 25px', sort: 'Cant' }
             , { h: 'Asig', style: 'width: 25px', sort: 'Asign' }
             , { h: 'Observaciones', style: 'width: 250px', sort: 'Observaciones' }
    ...
    $("#tPatrimonio").empty();
    $("#tPatrimonio").show();
    $("#tPatrimonio").append(GenerarEncabezadoTabla(encabezados));
    $("#tPatrimonio").append(encabezados);
    $("#tPatrimonio tbody").remove();
    $("#dPatrimonio").tmpl(registros).appendTo('#tPatrimonio');

//    var oTable = $("#tPatrimonio").dataTable({ "sScrollY": 200, "bRetrieve": true, "bFilter": false });
//    if (oTable) {
//        oTable.fnDestroy();
//        oTable = undefined;
//    }
//    $.fn.dataTableExt.oStdClasses.sWrapper = "dataTables_wrapper";
//    $("#tPatrimonio").dataTable({ "sScrollY": 200, "bRetrieve": true, "bFilter": false, "sDom": 'T<"clear">lfrtip' });
...
function CargarTablaLotes(registros) {
    ...
    var encabezados = [
             { h: 'Serial', style: 'width: 38px;', sort: 'Serial' },
...
function CargarTablaSQR(registros) {


    var encabezados = [
             { h: 'Codigo', style: 'width: 50px;', sort: 'Codigo' },
              { h: 'Descripcion', style: 'width: 250px;', sort: 'Descripcion' }
             , { h: 'Capacidad', style: 'width: 25px', sort: 'Capacidad' }
             , { h: 'SQR', style: 'width: 100px', sort: 'SQR' }
        ];
    ...
    $("#tSQR").empty();
    $("#tSQR").show();
    $("#tSQR").append(GenerarEncabezadoTabla(encabezados));
    $("#tSQR tbody").remove();
    $("#dSQR").tmpl(registros).appendTo('#tSQR');

    var oTable = $("#tSQR").dataTable({ "sScrollY":425, "bRetrieve": true, "bFilter": false });
    if (oTable) {
        oTable.fnDestroy();
        oTable = undefined;
    }
    $.fn.dataTableExt.oStdClasses.sWrapper = "dataTables_wrapper";
    $("#tSQR").dataTable({ "sScrollY": 425, "bRetrieve": true, "bFilter": false, "sDom": 'T<"clear">lfrtip' });
...
function ConsultarTubo(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ConsultarTubo',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
...
function CantidadProductosEnRampa(idEmpresa, Opcion) {
    ...
    if (Opcion == 3) {
        strProducto = $("#txtCodigo_").val();
        strEsPropio = "1";
        strVolumen = $("#txtVolumen_").val();
        CantidadSalen = $("#txtCantidad_").val();
    }
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/CantidadProductosEnRampa',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
function ValidarCapacidad(idEmpresa, Opcion) {
    ...
    if (Opcion == 1) {
        ...
        if (Opcion == 3) {
            strCapacidad = $("#txtCapacidad_").val();
            strCodigoProducto = $("#txtCodigo_").val();
        } else {
            strCapacidad = $("#txtCapacidad1").val();
            strCodigoProducto = $("#txtCodigo1").val();
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarCapacidad',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function EsGasStockeable(idEmpresa, Opcion) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/GasStockeable',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
                ...
                if (Opcion == 3)
                    $('#txtCapacidad_').attr('readonly', true);
            } else {
                if (Opcion == 1)
...
//Función para verificar que si un producto esta obligado a salir con lote de llenado
function EsLoteable(idEmpresa, Opcion) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, CodigoProducto: strCodigoProducto, ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'DocumentoTransferencia.aspx/EsProductoLoteable',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
                jAlert('El producto debe salir con lote de producción', 'Control de Lotes');
                $('#txtCodigo_').val('');
                return;
            } else {
                ConsultarProducto(jQuery.trim($('#lblIdEmpresa').text()), 3);
...
function EsRutaRampa(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/EsRutaRampa',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function EsVehiculoValido(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/EsVehiculoValido',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function ValidarSiHayInventarioAbierto(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarSiHayInventarioAbierto',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function ValidarCargueOBC(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarCargueOBC',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
function ValidarSiTieneListaPrecios(idEmpresa, cliente, producto, espropio) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarSiTieneListaPrecios',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function ValidarSiTieneCod_Facturacion(idEmpresa, producto, espropio) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarSiTieneCod_Facturacion',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == false) {
...
function RutaTieneAlmacen(idEmpresa) {
    ...
    var datos = JSON.stringify({ IdEmpresa: idEmpresa, CodigoRuta: $("#txtRuta").val(), Agencia: jQuery.trim($('#lblAgencia1').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
        url: 'DocumentoTransferencia.aspx/RutaTieneAlmacen',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length == 0) {
...
function FacturaGenerada(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/FacturaGenerada',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato != "") {
...
function DatosConductor(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/DatosConductor',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length == 0) {
...
function ConsultarArticuloPorNombre(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferencia.aspx/ConsultarArticuloPorNombre",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
...
function ConsultarConductorPorNombre(Nombre) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferencia.aspx/ConsultarConductorPorNombre",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (data, textStatus) {
...
function ConsultarArticuloPorCodigo(id) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DocumentoTransferencia.aspx/ConsultarArticuloPorCodigo",
        data: JSON.stringify(params),
        dataType: "json",
        async: false,
        success: function (data, textStatus) {
...
function CalcularVolumen(Opcion) {
    ...
    if (Opcion == 1) {
        ...
        Capacidad = $('#txtCapacidad').val();
         ...
         if (Opcion == 3) {
        Cantidad = $('#txtCantidad_').val();
        Capacidad = $('#txtCapacidad_').val();
        }else{ 
...
function AmacenarDetalleTablaTemporal(opcion) {
    ...
    if (opcion == 3) {
        registro.Codigo = jQuery.trim($('#txtCodigo_').val());
        registro.Capacidad = jQuery.trim($('#txtCapacidad_').val());
        registro.EntranSalen = jQuery.trim($('#txtCantidad_').val());
        if (jQuery.trim($('#txtVolumen_').val()) != 0) {
            registro.Cantidad = registro.Capacidad * registro.EntranSalen;
        } else {
            registro.Cantidad = 0;
        }
...
function AmacenarDetalleTablaTemporalAgenos(Opcion) {
    ...
    var data = JSON.stringify({ registro: registro, ModoCargue: 'M', Usuario: jQuery.trim($('#lblNombreUsuario').text()), IdEmpresa: $('#hdIdEmpresa').val(), ConectarA: jQuery.trim($('#lblBd').text()),Doc:'I' });
    $.ajax({
        url: 'DocumentoTransferencia.aspx/GrabarDetalleTemporalAgenos',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.IdError == '02') {
...
function AlmacenarDetalleTablaTemporalAgenos_Aut(Opcion, Codigo, Capacidad, Cantidad, Volumen, Propietario, Tubo,Lote,secuencia) {
    var registro = new Object();
    ...
    var data = JSON.stringify({ registro: registro, ModoCargue: 'A', Usuario: jQuery.trim($('#lblNombreUsuario').text()), IdEmpresa: $('#hdIdEmpresa').val(), ConectarA: jQuery.trim($('#lblBd').text()),Doc:'I' });
    $.ajax({
        url: 'DocumentoTransferencia.aspx/GrabarDetalleTemporalAgenos',
        data: data,
        success: function (response) {
...
if ((ItemsProductos.Productos.length == 0) && (ItemsProductosParticulares.ProductosParticulares == 0) && (ItemsProductosSinLote.ProductosSinLote == 0)) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ProcesarTransaferencia',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.IdError == "01") {
...
function EliminarProductoGrillaPropia(Producto, Volumen, EsPropio, Secuencia, Tubo,Capacidad) {
    ...
    var data = JSON.stringify({ registro: registro, Usuario: jQuery.trim($('#lblNombreUsuario').text()), IdEmpresa: jQuery.trim($('#lblIdEmpresa').text()), ConectarA: jQuery.trim($('#lblBd').text()),Doc:'I' });
    $.ajax({
        url: 'DocumentoTransferencia.aspx/EliminarProductoGrillaPropia',
        data: data,
        success: function (response) {
...
function VerificarEsatadoLLenoVacio(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/VerificarEstadoLLenoVacio',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            // 0 Cilindro vacio
...
function ValidarCantidadStock(idEmpresa, EsPropio,Opcion) {
    ...
    if (EsPropio == 1) {
        ...
        if (Opcion == 3) {
            Producto = jQuery.trim($('#txtCodigo_').val());
            Cantidad = jQuery.trim($('#txtCantidad_').val());
            Capacidad = jQuery.trim($('#txtCapacidad_').val());
            if (jQuery.trim($('#txtVolumen_').val()) != 0) {
                Volumen = Cantidad * Capacidad;
            } else {
                Volume = 0;
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarCantidadStock',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            ...
            if (Opcion == 1) {
                if (jQuery.trim($('#txtVolumen').val()) != '0') {
                    ...
                    if (Volumen > Tdato) {
                        jAlert('No existe Inventario suficiente para este realizar salida a este producto, el Inventario actual es de: ' + Tdato + ' ', '');
                        return;
                    }
            ...
            if (idEmpresa == 25 && Volumen > 0) {
                ValidarSiTieneListaPrecios(idEmpresa, "0000001", Producto, Opcion)
            } else {
                AmacenarDetalleTablaTemporal(Opcion);
            }
...
function CargarProductosGrilla(Opcion) {
    ...
    if(Opcion == 3){
        ...
        AddProducto.Codigo = jQuery.trim($('#txtCodigo_').val());
        AddProducto.CodigoTubo = jQuery.trim($('#txtCodigoTubo_').val());
        AddProducto.Descripcion = jQuery.trim($('#txtDescripcion_').val());
        AddProducto.Capacidad = jQuery.trim($('#txtCapacidad_').val());
        AddProducto.Cantidad = jQuery.trim($('#txtCantidad_').val());
        AddProducto.Propiedad = jQuery.trim($('#txtPropiedad_').val());
        AddProducto.Observacion = "M";
        var cant = jQuery.trim($('#txtCantidad_').val());
        var Cap = jQuery.trim($('#txtCapacidad_').val());
        if (jQuery.trim($('#txtVolumen_').val()) != 0) {
            AddProducto.Volumen = AddProducto.Capacidad * AddProducto.Cantidad; //    jQuery.trim($('#txtVolumen').val());
...
//        function clsListaProductosSinLote() {

//            this.ProductosSinLote = new Array()
//        };
//        ItemsProductosSinLote = new clsListaProductosSinLote();



        ItemsProductosSinLote.ProductosSinLote[ItemsProductosSinLote.ProductosSinLote.length] = AddProducto;
...
function CargarDatagridSinLote() {

    $("#TProductos_SinLote tbody").remove();
    $('#dProductos_SinLote').tmpl(ItemsProductosSinLote.ProductosSinLote).appendTo('#TProductos_SinLote')
}

function CargarDatagridSQR() {

    $("#tSQR tbody").remove();
    $('#dSQR').tmpl(ItemsSQR.ProductosSQR).appendTo('#tSQR')
}
...
function LimpiarControles(opcion) {
...
function clsListaSQR() {

    this.ProductosSQR = new Array()
};
ItemsSQR = new clsListaSQR();
...
function clsListaCilindrosPatri() {

    this.CilindrosPatri = new Array()
};
ItemsCilindrosPatri = new clsListaCilindrosPatri();
...
function EliminarSinLote(idProducto, volumen, EsPropio, Capacidad) {


    if (confirm('Esta seguro de eliminar el Producto seleccionado?')) {
        Prod = new Array();
        var cantidadActual;
        for (var i = 0; i < ItemsProductosSinLote.ProductosSinLote.length; i++) {
            if (ItemsProductosSinLote.ProductosSinLote[i].Codigo == idProducto && ItemsProductosSinLote.ProductosSinLote[i].Volumen == volumen && ItemsProductosSinLote.ProductosSinLote[i].Capacidad == Capacidad) {
                EliminarProductoGrillaPropia(ItemsProductosSinLote.ProductosSinLote[i].Codigo, ItemsProductosSinLote.ProductosSinLote[i].Volumen, EsPropio, 0, 0, Capacidad);
                cantidadActual = ItemsProductosSinLote.ProductosSinLote[i].Cantidad;
            }
            else {
                Prod[Prod.length] = ItemsProductosSinLote.ProductosSinLote[i]
            }
        }
...
//        $("#lblTotalCilindrosPraxair").text(CilindrosActuales);
        ...
        ItemsProductosSinLote.ProductosSinLote = Prod;
        CargarDatagridSinLote();
        $('#txtCodigo_').focus();
    }
    else {
...
$(function () {
    ...
    $("#txtRuta").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: 'DocumentoTransferencia.aspx/RutasPorSucursal',
...
function ValidarExsiteSQR(Producto, Capacidad, SRQ) {
    var Exis = false
    for (var i = 0; i < ItemsSQR.ProductosSQR.length; i++) {
        if (ItemsSQR.ProductosSQR[i].Codigo == Producto) {
            if (ItemsSQR.ProductosSQR[i].Capacidad == Capacidad) {

                if (ItemsSQR.ProductosSQR[i].SQR == SRQ) {
                    Exis = true;
                }
...
function ValidarExsiteProductoGrillaPropiosSinLote(Producto, Capacidad, Volumen) {
    var Exis = false
    for (var i = 0; i < ItemsProductosSinLote.ProductosSinLote.length; i++) {
        if (ItemsProductosSinLote.ProductosSinLote[i].Codigo == Producto) {
            if (ItemsProductosSinLote.ProductosSinLote[i].Capacidad == Capacidad) {

                if (Volumen != 0) {
                    Exis = true;
                    return Exis;
                } else {
                    if (ItemsProductosSinLote.ProductosSinLote[i].Volumen == Volumen) {
                        Exis = true;
                        return Exis;
                    }
                }
...
$('#btnPatrimonio').click(function () {
    $("#list").clearGridData(); // LIMPIAR GRILLA
    $("#ModalPatrimonio").dialog({
        height: 500,
        width: 1000,
        modal: true
    });
...
function FilaSeleccionada(id, IdGrilla) {
    ...
    if (IdGrilla == 2) {// viene de grilla de Conductores
      ...
      if (IdGrilla == 3) {// viene de grilla de articulos
        var ArtSeleccionado = jQuery('#list').getCell(id, "Codigo");


        $("#ModalBusqueda").dialog("destroy")
        $('#txtCodigo_').val(ArtSeleccionado);
        $('#txtCodigo_').focus();
    }
};
...
function EliminarTablaTemporalInicial(idEmpresa) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/EliminaDetalleTemporalInicial',
        data: data,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            //            if (Tdato.IdError == '02') {
...
function GuardarTablaTemporaldeStock() {
    ...
    for (var i = 0; i < ItemsProductos.Productos.length; i++) {
        ...
        AlmacenarDetalleTablaTemporalAgenos_Aut(1, ItemsProductos.Productos.Codigo, ItemsProductos.Productos.Capacidad, ItemsProductos.Productos.Cantidad, ItemsProductos.Productos.Volumen, '', '','',0) 
...
function ValidarPedidos(Pedidos, Sucursal) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarPedidos',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato == true) {
...
function TotalCilindrosSerieLote() {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/TotalCilindrosSerieLote',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
...
function EliminarTablaTemporalLoteSerie(Serial) {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/BorrarRegistroLoteSerie',
        data: data,
        success: function (response) {
            ConsultarSerialLote();
            TotalCilindrosSerieLote();
...
function EliminarTablaTemporaSQR(Producto,Capacidad) {

    if (confirm('Esta Seguro de Eliminar el Producto: ' + Producto + '  de la grilla de SQR?')) {
        var data = JSON.stringify({ Producto: Producto,Capacidad:Capacidad, Usuario: jQuery.trim($('#lblNombreUsuario').text()), ConectarA: jQuery.trim($('#lblBd').text()) });
        $.ajax({
            url: 'DocumentoTransferencia.aspx/BorrarRegistroSQRTemp',
            data: data,
            success: function (response) {
                ConsultarValidezSQR();
                $('#txtproductoSQR').focus();
...
function ConsultaLotePorSerie() {
    ...
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ConsultarLotePorSerial',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
            if (Tdato.length != 0) {
...
function EditarPatri(codigo,descripcion,capacidad,cantidad,asignacion,observacion) {


    $('#txtCodigoPAsig').text(codigo);
    $('#txtArticuloAsig').text(descripcion);
    $('#txtCapacidadAsig').text(capacidad);
    $('#txtcantidadAsig').text(cantidad);
    $('#txtAsigna').val(asignacion);
    $('#txtObservacionesAsig').val(observacion);
    $('#txtAsigna').focus();
    $("#txtAsigna").numeric(".");

    $("#DivModificarPatri").dialog({
        height: 300,
        width: 550,
        modal: true
    });
...
//Función Carga la Informacion del lote
function ValidarSalidaCilindrosLLenos(subdeposito) {

    var datos = JSON.stringify({ SubdePosito: subdeposito });
    $.ajax({
        url: 'DocumentoTransferencia.aspx/ValidarSalidaCilindrosLLenos',
        data: datos,
        success: function (response) {
            var Tdato = (typeof response.d) == 'string' ? eval('(' + response.d + ')') : response.d;
