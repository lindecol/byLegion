...
function AmacenarDetalleTablaTemporalAgenos(Opcion) {
    ...
    var data = JSON.stringify({ registro: registro, ModoCargue: 'M', Usuario: jQuery.trim($('#lblNombreUsuario').text()), IdEmpresa: $('#hdIdEmpresa').val(), ConectarA: jQuery.trim($('#lblBd').text()) });
    $.ajax({
