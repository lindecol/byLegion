...
namespace TransferenciaZonaFrancaV2.PaginasReportes
{
    public partial class CilindrosCargados : System.Web.UI.Page
    {
        ...
        static CilindrosCargados()
        {
            CilindrosCargados.Conectar_a = "";
        }

        public CilindrosCargados()
        {
        }
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            CilindrosCargados.Conectar_a = empresa.ConsultarConexion(this.Session["SESSION_EMPRESA"].ToString().Trim());
            Pallet pallet = new Pallet();
            DataSet dataSet = new DataSet();
            dataSet = pallet.CilindrosEnPallets(this.lblDocumento.Text.Trim(), CilindrosCargados.Conectar_a);
            ...
            reportParameter[0] = new ReportParameter("FECHA", now.ToShortDateString());
