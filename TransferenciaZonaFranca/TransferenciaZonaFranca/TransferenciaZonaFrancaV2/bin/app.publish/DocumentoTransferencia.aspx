<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/MasterPage.Master" AutoEventWireup="true" CodeBehind="DocumentoTransferencia.aspx.cs" Inherits="TransferenciaZonaFrancaV2.DocumentoTransferencia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div>
            ...
            <div id="Titulos" style="float:left;width:490px" >  Envío Remesa Intercompañia </div>
             ...
             <div id="DivEmpresa" style="float:left" >
                      <div class="fila"  style="float:left;width:130px" >
                            ...
                            <asp:Label ID="lblIdEmpresa" runat="server" Enabled="false" 
                                style="font-weight: 700"></asp:Label> 
                                <asp:Label ID="lblllenosPGI" runat="server" Enabled="false" 
                                style="font-weight: 700"></asp:Label> 
                    ...
                    <div style="width:70px;float:left;text-align:center" >
                     ...
                     <div style="width:34px; float:left;text-align:center; height: 32px;" >
                        <span>        
                            ...
                            <input id="btnAgregarProducto" style="background-image:url('App_Themes/Imagenes/Download.png');background-repeat: no-repeat; width: 31px; width: 30px; height: 25px; border-bottom-style: none; border-bottom-color: inherit; border-bottom-width: 0px;margin-top:7px" type="button" title="Agregar Grilla" onclick="return btnAgregarProducto_onclick()" />
                         </span>
                    </div>
   ...
   <div id="tabs-3">
    ...
    <div style="width:900px;float:left">
            ...
            <asp:Panel ID="Panel5" runat="server" Width="900px" Height="38px" BackColor="#F3F3F3">

                <div>
                    <div style="width:70px;float:left;text-align:center" >
                        <span><label  style="font-weight:bold;font-size:11px"   for="txtproductoSQR">Código</label></span>        
                        <span><input id="txtproductoSQR" runat = "server" name="txtproductoSQR" maxlength="10" type="text"  style="width:70px;font-size:11px"/></span>
                    </div>

                    <div style="width:510px;float:left;text-align:center" >
                        <span><label  style="font-weight:bold;font-size:11px" for="txtDescripcionSQR">Descripición</label></span>        
                        <span><input id="txtDescripcionSQR" runat = "server" name="txtDescripcionSQR" maxlength="10" type="text"  style="width:510px;font-size:11px"/></span>
                    </div>

                    <div style="width:60px;float:left;text-align:center" >
                        <span><label  style="font-weight:bold;font-size:11px" for="txtCapacidadSQR">Capacidad</label></span>        
                        <span><input id="txtCapacidadSQR" runat = "server" name="txtCapacidadSQR" maxlength="10" type="text"   style="width:60px;text-align:center;font-size:11px"/></span>
                    </div>

                      <div style="width:200px;float:left;text-align:center" >
                        <span><label  style="font-weight:bold;font-size:11px" for="txtLote">Código SQR</label></span>        
                        <span>
                        <input id="txtcodigoSQR" runat = "server" name="txtcodigoSQR" maxlength="50" type="text" style="width:200px;font-size:11px" /></span>
                    </div>

                     <div style="width:20px;float:left;text-align:center" >
                         <input id="btnAgregarSQR"  style="background-image:url('App_Themes/Imagenes/Download.png');background-repeat: no-repeat; width: 31px; width: 30px; height: 25px; border-bottom-style: none; border-bottom-color: inherit; border-bottom-width: 0px;margin-top:7px" type="button"  title="Agregar Grilla"/>
                    </div>
               ...
               <table id="tSQR" class="table-striped" style="width: 100%">
                    <thead>
                    </thead>
                    <tbody></tbody>
            </table>
            <script id="dSQR"  type="text/x-jQuery-tmpl">
             <tr style="font-size:11px" >
                    <td  style="width:70px;text-align:center;">
                        ${Codigo}
                    </td>
                    ...
                    <td>
                        <a href="#" onclick="EliminarTablaTemporaSQR('${Codigo}',${Capacidad});return false;">Eliminar</a>
                     </td>
                  </tr>
           </script>
      ...
      <div id="gridConductores">
         ...
         <div id="DivModificarPatri" title="Asignar Patrimonio" style="display: none">
                ...
                <div class="fila">
                   ...
                   <script src="Scripts/DocumentoTransferencia_03062016.js" type="text/javascript"></script>
