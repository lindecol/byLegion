...
{
    public partial class TomaPedidos : System.Web.UI.Page
    {
        ...
        public static float CantidadProductosEnRampa(int IdEmpresa, string Codigo, string EsPropio, string EsLleno, string Capacidad, string Agencia, string ConectarA, int SubDep)
        {
            ...
            float CantidaRampa = producto.CantidadProductosEnRampa(SubDep, Agencia, Agencia, TomaPedidos.iGrupoId, Codigo, IdEmpresa, EsPropio, EsLleno, ConectarA);
            return CantidaRampa;
        }
        ...
        public static List<Producto> ConsultarCargueAutomaticoZF(int IdEmpresa, string Ruta, string Usuario, string Agencia, string ConectarA)
        {
            ...
            return Itemscargue.ConsultarCargueAutomaticoZF(IdEmpresa, Usuario.Trim(), Agencia, Ruta, ConectarA, "P");
        }
        ...
        public static void EliminarProductoGrillaPropia(Producto registro, string Usuario, int IdEmpresa, string ConectarA)
        {
            ...
            registro.EliminarProductoGrillaPropia(registro.Codigo, registro.Volumen, registro.EsPropio, IdEmpresa, registro.Secuencia, registro.Tubo, Usuario.Trim(), ConectarA, registro.Capacidad, "P");
        }
        ...
        {
            Ruta ruta = new Ruta();
            return ruta.EsRutaRampa(IdEmpresa, Agencia, CodigoRuta, TomaPedidos.iGrupoId, ConectarA);
        }
        ...
        {
            return (new Producto()).GasStockeable(IdEmpresa, CodigoProducto, TomaPedidos.iGrupoId, ConectarA);
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static string NroPedidoGenerado(int IdEmpresa, string AgenciaOrigen, string ConectarA)
        {
            return (new Documento()).NroPedidoGenerado(IdEmpresa, AgenciaOrigen, ConectarA);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (RecargarPagina == string.Empty)
                {
                    ...
                    TomaPedidos.iGrupoId = 1;
                    TomaPedidos.iDocumentoID = 21;
                    ...
                    if (empresa.ConsultarMultipleSesion(this.lblIdEmpresa.Text.ToString(), this.lblNombreUsuario.Text.Trim(), Conectar_a, "P"))
                    {
                    ...
                    {
                        GrupoId = TomaPedidos.iGrupoId,
                        EmpresaId = Convert.ToInt32(this.lblIdEmpresa.Text.ToString()),
                        Sucursal = strAgencia,
                        DocumentoId = TomaPedidos.iDocumentoID,
                        TipoRetorno = 2,
                        Prefijo = strAgencia,
                        ConexionEmpresa = Conectar_a
                    };
                    List<IEntity> entities = new List<IEntity>();
                    clsTalonario.Consultar();
                    clsTalonario.EliminarDatosTemporales(Convert.ToInt32(this.lblIdEmpresa.Text.ToString()), this.lblNombreUsuario.Text.Trim(), Conectar_a, "P");
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static Mensaje ProcesarTomaPedido(Documento registro, string Usuario, int IdEmpresa, string Agencia, string ConectarA)
        {
            Talonario clsTalonario = new Talonario()
            {
                GrupoId = TomaPedidos.iGrupoId,
            ...
            {
                MsjProceso = registro.InsertarTransferenciaPedido(registro, Usuario.Trim(), ConectarA, strNumeroDocumento);
            }
            ...
            else
            {
                ...
                strNumeroDocumento = registro.NroPedidoGenerado(IdEmpresa, Agencia, ConectarA);
        ...
        public static List<Ruta> RutaTieneAlmacen(int IdEmpresa, string CodigoRuta, string Agencia, string ConectarA)
        {
            List<Ruta> rutas = new List<Ruta>();
            Ruta ruta = new Ruta();
            return ruta.RutaTieneAlmacen(IdEmpresa, Agencia, CodigoRuta, TomaPedidos.iGrupoId, ConectarA);
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static double ValidarCantidadStock(int IdEmpresa, int Subdeposito, string Producto, string Usuario, string ConectarA, string Doc)
        {
            TransferenciasZF.Data.Producto producto = new TransferenciasZF.Data.Producto();
            double CantidadStock = producto.ValidarCantidadStock(IdEmpresa, Subdeposito, Producto, Usuario.Trim(), ConectarA, Doc);
