<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/MasterPage.Master" AutoEventWireup="true" CodeBehind="RemitoAgenciaWeb.aspx.cs" Inherits="TransferenciaZonaFrancaV2.RemitoAgenciaWeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div>
            ...
            <div id="Titulos" style="float:left;width:490px" >  REMITO AGENCIA</div>
        ...
        <div style="width:490px;float:left">
                ...
                <div class="fila">
                  ...
                  <div class="fila" id="of_origen">
                    <span  class="etiqueta"><label for="CmbOficinaOrigen" >Oficina Origen</label></span>        
                    <span  class="form-el"><asp:DropDownList ID="CmbOficinaOrigen" Width="250px" runat="server"></asp:DropDownList></span>
                </div>
                <div class="fila">
                    <span class="etiqueta"><label for="cmbEmpresaDestino">Empresa Destino (*)</label></span>        
                    <span  class="form-el"><input id="cmbEmpresaDestino" runat = "server" name="cmbEmpresaDestino" style="width:250px" disabled="disabled" readonly="readonly" maxlength="20" type="text" /></span>
                </div>
                <div class="fila">
                 ...
                 <div class="fila"id="of_destino" style="display: none" >
                    <span  class="etiqueta"><label for="CmbOficinaDestino">Oficina Destino (*)</label></span>        
                    <span  class="form-el"><asp:DropDownList ID="CmbOficinaDestino" Width="250px" runat="server"></asp:DropDownList></span>
                </div>
                ...
                <div>
                    ...
                    <input id="hdGenerarCons" type="hidden" runat="server"  />
                     <input id="hdSubdepositoDestino" type="hidden" runat="server"  />
                      ...
                      <input id="hdSubdepositoOf" value ="0" type="hidden" runat="server"  />
                      <input id="hdSubdepositoLogueo" value ="0" type="hidden" runat="server"  />
            ...
            <asp:Panel ID="Panel3" runat="server" Width="900px" Height="38px" BackColor="#F3F3F3">
                ...
                <div>
                    ...
                    <div style="width:200px;float:left;text-align:center" >
                        ...
                        <span>
                        <input id="txtLote" runat = "server" name="txtLote" maxlength="50" type="text" style="width:200px;font-size:11px" readonly="readonly"/></span>
                    </div>
    ...
    <br />
     <div style="float:left;text-align:center" >
      ...
      <%-- <input id="btnRemito" type="button" value="Remito"  />--%>
       <input id="btnVista" type="button" value="Vista Factura" style="display: none" />
     ...
     <script src="Scripts/RemitoAgencia_030815.js" type="text/javascript"></script>
     <%--<script src="Scripts/RemitoAgencia_210715.js" type="text/javascript"></script>--%>
