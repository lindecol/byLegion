<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/MasterPage.Master" AutoEventWireup="true" CodeBehind="GuiaSalidaZonaFranca.aspx.cs" Inherits="TransferenciaZonaFrancaV2.GuiaSalidaZonaFranca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div>
            ...
            <div id="Titulos" style="float:left;width:490px" >  Guia Salida Carga </div>
        ...
        <div style="width:490px;float:left">
                ...
                <div class="fila">
                 ...
                 <div class="fila">
                    <span class="etiqueta"><label>Ruta Salida Carga (*)</label></span>
                    <span class="form-el"><input id="txtRutaSalida" runat = "server" name="txtRutaSalida" onkeyup="this.value=this.value.toUpperCase();" maxlength="20" type="text" /></span>
                </div>

                 <div class="fila">
                    <span class="etiqueta"><label for="txtVehiculo">Vehiculo (*)</label></span>        
                    <span class="form-el"><input id="txtVehiculo" runat = "server" name="txtVehiculo"  onkeyup="this.value=this.value.toUpperCase();" maxlength="20" type="text" onclick="return txtVehiculo_onclick()" /></span>
                </div>
            ...
            <asp:Panel ID="Panel1" runat="server" Width="900px" Height="38px" BackColor="#F3F3F3">
                ...
                <div>
                    ...
                    <input id="hdGenerarCons" type="hidden" runat="server"  />
                     ...
                     <input id="hdSubdepositoCamionGuia" type="hidden" runat="server"  />
                     <input id="hdPuntoDeVentaCamionGuia" type="hidden" runat="server"  />
            ...
            <tbody>
                <tr style="font-size:11px">
                    ...
                    <td  style="width:30px">
                     ...
                     <td>
                        <a href="#" onclick="Eliminar('${Codigo}','${Volumen}','1');return false;">Eliminar</a>
                     </td>
                  </tr>
             </tbody>
           </script>
     ...
     <div style="float:left;text-align:center" >
      ...
      <%-- <input id="btnRemito" type="button" value="Remito"  />--%>
       ...
       <asp:Label ID="LblNumeroFacturaGenerada" runat="server"  Font-Size="Medium" Enabled="false" ></asp:Label> 
          ...
          <asp:Label ID="lblGuiaCamionGenerada" runat="server"  Font-Size="Medium" Enabled="false" ></asp:Label> 
       <asp:Label ID="lblNumeroGuiaCamionGenerada" runat="server"  Font-Size="Medium" Enabled="false" ></asp:Label> 
    </div>
  ...
  <%--      <div id="DivReporteFactura" title="Busqueda Articulos"  class="TituloVentana" style="display: none" >
     ...
     <script src="Scripts/DocumentoGuiaSalida_1404.js" type="text/javascript"></script>
