...
{
    public partial class GuiaSalidaZonaFranca : System.Web.UI.Page
    {
        ...
        public static float CantidadProductosEnRampa(int IdEmpresa, string Codigo, string EsPropio, string EsLleno, string Capacidad, string Agencia, string ConectarA, int SubDep)
        {
            ...
            float CantidaRampa = producto.CantidadProductosEnRampa(SubDep, Agencia, Agencia, GuiaSalidaZonaFranca.iGrupoId, Codigo, IdEmpresa, EsPropio, EsLleno, ConectarA);
            return CantidaRampa;
        }
        ...
        public static List<Producto> ConsultarCargueAutomaticoZF(int IdEmpresa, string Ruta, string Usuario, string Agencia, string ConectarA)
        {
            ...
            return Itemscargue.ConsultarCargueAutomaticoZF(IdEmpresa, Usuario.Trim(), Agencia, Ruta, ConectarA, "G");
        }

        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static List<Producto> ConsultarCargueAutomaticoZF_GuiaCarga(int IdEmpresa, string Pto_venta, string Usuario, string Agencia, string ConectarA)
        {
            List<Producto> productos = new List<Producto>();
            Producto Itemscargue = new Producto();
            return Itemscargue.ConsultarCargueAutomaticoZF_GuiaCarga(IdEmpresa, Usuario.Trim(), Agencia, Pto_venta, ConectarA);
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static void EliminaDetalleTemporalInicial(int TempIdEmpresa, string Usuario, string ConectarA, string Doc)
        {
            (new Talonario()).EliminarDatosTemporalesIniciales(TempIdEmpresa, Usuario.Trim(), ConectarA, Doc);
        }

        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static void EliminarProductoGrillaPropia(Producto registro, string Usuario, int IdEmpresa, string ConectarA)
        {
            (new Mensaje()).IdError = "01";
            registro.EliminarProductoGrillaPropia(registro.Codigo, registro.Volumen, registro.EsPropio, IdEmpresa, registro.Secuencia, registro.Tubo, Usuario.Trim(), ConectarA, registro.Capacidad, "G");
        }

        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static bool EsRemitoCamion(int IdEmpresa, string CodigoRuta, string Agencia, string ConectarA)
        {
            return (new Ruta()).EsRemitoCamion(IdEmpresa, Agencia, CodigoRuta, ConectarA);
        }
        ...
        {
            Ruta ruta = new Ruta();
            return ruta.EsRutaRampa(IdEmpresa, Agencia, CodigoRuta, GuiaSalidaZonaFranca.iGrupoId, ConectarA);
        }

        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static bool EstaEnTransitoCamion(int IdEmpresa, string PlacaVehiculo, string ConectarA)
        {
            if (IdEmpresa != 25)
            {
                IdEmpresa = 25;
            ...
            return (new Ruta()).EstaEnTransitoCamion(IdEmpresa, PlacaVehiculo, ConectarA);
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static bool EsVehiculoValidoGuiaCamion(int IdEmpresa, string PlacaVehiculo, string ConectarA)
        {
            if (IdEmpresa != 25)
            {
                IdEmpresa = 25;
            ...
            return (new Ruta()).EsVehiculoValidoGuiaCamion(IdEmpresa, PlacaVehiculo, ConectarA);
        }
        ...
        {
            return (new Producto()).GasStockeable(IdEmpresa, CodigoProducto, GuiaSalidaZonaFranca.iGrupoId, ConectarA);
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static string GuiaCamionGenerada(int IdEmpresa, string comprobante, string Agencia, string ConectarA)
        {
            return (new Documento()).GuiaCamionGenerada(IdEmpresa, Agencia, comprobante, ConectarA);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (RecargarPagina == string.Empty)
                {
                    ...
                    GuiaSalidaZonaFranca.iGrupoId = 1;
                    GuiaSalidaZonaFranca.iDocumentoID = 21;
                    ...
                    if (empresa.ConsultarMultipleSesion(this.lblIdEmpresa.Text.ToString(), this.lblNombreUsuario.Text.Trim(), Conectar_a, "G"))
                    {
                    ...
                    {
                        GrupoId = GuiaSalidaZonaFranca.iGrupoId,
                        EmpresaId = Convert.ToInt32(this.lblIdEmpresa.Text.ToString()),
                        Sucursal = strAgencia,
                        DocumentoId = GuiaSalidaZonaFranca.iDocumentoID,
                        TipoRetorno = 2,
                        Prefijo = strAgencia,
                    ...
                    clsTalonario.EliminarDatosTemporales(Convert.ToInt32(this.lblIdEmpresa.Text.ToString()), this.lblNombreUsuario.Text.Trim(), Conectar_a, "G");
        ...
        public static Mensaje ProcesarTransaferencia(Documento registro, string Usuario, int IdEmpresa, string Agencia, string ConectarA)
        {
            ...
            {
                mensaje.IdError = "02";
                MsjProceso = "El consecutivo del documento no se genero, Revise que este en el subdeposito y empresa correctos";
            }
            ...
            {
                MsjProceso = registro.InsertarTransferencia(registro, Usuario.Trim(), ConectarA, strNumeroDocumento, "S");
            }
        ...
        public static List<Ruta> RutaTieneAlmacen(int IdEmpresa, string CodigoRuta, string Agencia, string ConectarA)
        {
            List<Ruta> rutas = new List<Ruta>();
            Ruta ruta = new Ruta();
            return ruta.RutaTieneAlmacen(IdEmpresa, Agencia, CodigoRuta, GuiaSalidaZonaFranca.iGrupoId, ConectarA);
        }
        ...
        public static double ValidarCantidadStock(int IdEmpresa, int Subdeposito, string Producto, string Usuario, string ConectarA)
        {
            ...
            double CantidadStock = producto.ValidarCantidadStock(IdEmpresa, Subdeposito, Producto, Usuario.Trim(), ConectarA, "G");
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static List<Ruta> ValidarPapeleriaRuta(int IdEmpresa, string CodigoRuta, string Agencia, string ConectarA)
        {
            List<Ruta> rutas = new List<Ruta>();
            return (new Ruta()).ValidarPapeleriaRuta(IdEmpresa, CodigoRuta, Agencia, ConectarA);
        }
